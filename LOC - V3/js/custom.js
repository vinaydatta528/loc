//Electroinc signature Place holder
$(document).ready(function(){
$(".siginput").click(function(){
   $(".sign-ip").show();
});
});
...
function checkValid () {
var cbChecked1 = $(".check1").is(":checked"); 
var cbChecked2 = $(".check2").is(":checked");
var cbChecked3 = $(".check3").is(":checked");
var cbChecked4 = $(".check4").is(":checked");
var cbChecked5 = $(".check5").is(":checked");  // check if checked
var hasText = $(".siginput").val().length > 0;  // check if it has text
  
  $(".accept").prop("disabled",  !cbChecked1 || !hasText || !cbChecked2 || !cbChecked3 || !cbChecked4 || !cbChecked5  );
}

$( function () {
  checkValid(); // run it for the first time
 
$(".siginput").on("input", checkValid)  // bind textbox
$(".check1").on("change", checkValid);
$(".check2").on("change", checkValid);
$(".check3").on("change", checkValid);
$(".check4").on("change", checkValid);
 $(".check5").on("change", checkValid); // bind checkbox
});
...
$.validate({
	form : '#registration, #pinformation,#guarantorinfo,#incomeinfo,#bankinformation-eft,#approvalstatus,#bankinformation-debit,#bankinformation-chk,#login-application,#login-portal,#bankinformation',
...
function validateForm() {
  var x = document.forms["approvalstatus"]["electrosign"].value;
  if (x == "") {
    document.getElementById("electrosign-error").innerHTML="Name must be filled out";
    return false;
  }
  else{
	  return true;
