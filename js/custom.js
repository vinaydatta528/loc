...
$.validate({
	form : '#registration, #pinformation,#guarantorinfo,#incomeinfo,#approvalstatus,#bankinformation-eft,#bankinformation-debit,#bankinformation-chk,#login-application,#login-portal',
